...
| Return body <br> (in case of success) | {<br>"topic_model_id": int <br>"topic_model_name": str,<br>"num_topics": int,<br>"topic_names": [str, ...],<br>"status": "topics_to_be_named",<br>"topic_previews": [<br>{<br>"important_words": [ str, ... ],<br>"examples": [str, ... ]<br>} ... <br># The length of this list is equal to "num_topics"<br>]<br>} |
