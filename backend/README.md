...
| Return body <br> (in case of success) | {<br>"topic_model_id": int # The id of the topic detector just created<br>"name": str,<br>"num_topics": int,<br>"topic_names": NULL, <br>"status": "training"<br> } |
...
| Method                                | GET                                                                                                                                                                                                                                                                             |
| Request body                          | -                                                                                                                                                                                                                                                                               |
| Return body <br> (in case of success) | {<br>"topic_model_id": int <br>"name": str,<br>"num_topics": int,<br>"topic_names": One_of(NULL, [str, ...])<br>"topic_previews": [<br>{<br>"important_words": [ str, ... ]<br>"examples": [str, ... ]<br>} ...<br># The length of this list is equal to "num_topics"<br>]<br>} |
...
| Method                                | POST                                                                                                                                                                                                                                                               |
| Request body                          | [str, ...] # The length of this list must be equal to "num_topics"                                                                                                                                                                                                 |
| Return body <br> (in case of success) | {<br>"topic_model_id": int <br>"name": str,<br>"num_topics": int,<br>"topic_names": [str, ...]<br>"topic_previews": [<br>{<br>"important_words": [ str, ... ]<br>"examples": [str, ... ]<br>} ... <br># The length of this list is equal to "num_topics"<br>]<br>} |
